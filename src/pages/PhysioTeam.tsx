        ...
        <section className="relative py-20 bg-gradient-to-br from-primary to-secondary text-primary-foreground overflow-hidden">
          ...
          <div className="container-physio relative z-10 text-center">
            ...
            <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto animate-fade-in-up stagger-1">
              Meet our experienced team of physiotherapy professionals dedicated
              to your care.
            </p>
          </div>
        </section>
  ...
  <div className="container-physio">
    <div className="text-center mb-16">
      ...
      <p className="section-subtitle mx-auto">
        Our team combines years of experience with a passion for helping
    ...
    {team?.length > 0 && (
      <>
        {/* FIRST MEMBER + STATIC BIO SIDE BY SIDE */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-5">
              ...
              <div className="lg:col-span-3 p-8">
                ...
                {/* Qualifications */}
                {team[0].qualifications?.length > 0 && (
                  <div className="mb-4">
                    ...
                    <ul className="pl-7 space-y-1">
                      {team[0].qualifications.map((qual) => (
                        <li
                          key={qual}
                ...
                {/* Special Interests */}
                {team[0].specializations?.length > 0 && (
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex flex-wrap gap-2 pl-7">
                      {team[0].specializations.map((spec) => (
                        <span
                          key={spec}
          ...
          <div className="bg-card rounded-2xl overflow-hidden card-hover border border-border">
            <div className="p-8">
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Onele Mafunda is a dedicated and compassionate physiotherapist
                who believes that movement is the foundation of a healthy and
                fulfilling life. An avid runner and regular gym-goer, Onele
                practices what she preaches, understanding first-hand the
                demands that sport, work, and daily life place on the body.
              </p>

              <p className="text-muted-foreground mb-6 leading-relaxed">
                With a genuine passion for helping people recover, move better,
                and live pain-free, Onele is known for taking a hands-on,
                patient-centred approach to care. She values building strong
                relationships with her patients, listening to their goals, and
                creating personalised treatment plans that support long-term
                recovery and wellbeing.
              </p>

              <p className="text-muted-foreground leading-relaxed">
                Family-oriented and actively involved in church and community,
                Onele brings empathy, integrity, and respect into every
                interaction. Whether working with athletes, post-surgical
                patients, or individuals managing chronic pain, her mission is
                simple: to help people get back to doing what they love with
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                  Our team is committed to ongoing professional development,
                  staying current with the latest research and treatment
                  techniques to provide you with the best possible care.
                </p>
        ...
        <section className="section-padding bg-primary text-primary-foreground">
          <div className="container-physio text-center">
            ...
            <Button
              asChild
              className="bg-background text-foreground hover:bg-background/90 rounded-full px-8 py-6 text-lg"
            >
