        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="inline-block">
              <img src={logo} alt="MM Physio" className="h-16 w-auto brightness-0 invert" />
            </Link>
            <p className="text-background/70 text-sm leading-relaxed">
              Providing expert physiotherapy care to help you move better, feel better, and live better. Your recovery is our priority.
            </p>
            {/* Social Links */}
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-background/70">
                  123 Rivonia Road, Sandton<br />
                  Johannesburg
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="tel:+27112345678" className="text-background/70 hover:text-primary transition-colors">
                  +27 11 234 5678
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="mailto:info@mmphysio.co.za" className="text-background/70 hover:text-primary transition-colors">
                  info@mmphysio.co.za
                </a>
              </li>
              <li className="flex items-start gap-3">
